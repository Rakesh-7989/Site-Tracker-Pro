...
const app = [
  ...
  read("src/lib/dprOfflineSync.ts"),
  ...
  read("src/app/advancedProcurementQueries.ts"),
  ...
  read("src/app/projectFinancialQueries.ts"),
  ...
  read("src/app/crossPoQueries.ts"),
  read("src/app/poReceiptQueries.ts"),
  ...
  read("src/app/financeQueries.ts"),
  read("src/app/designQueries.ts"),
  read("src/app/workflowEngine.ts"),
  read("src/app/workflowDefinitions.ts"),
  read("src/app/qualityQueries.ts"),
  read("src/app/statutoryQueries.ts"),
  ...
  read("src/app/consultancyAuditQueries.ts"),
  read("src/app/formEngine.ts"),
  read("src/components/ui/SchemaForm.tsx"),
  read("src/app/procurementQuotes.ts"),
  read("src/app/outboxQueries.ts"),
  read("src/app/spaceQueries.ts"),
  read("src/hooks/useLocationContext.ts"),
  read("src/app/domainMap.ts"),
  ...
  read("src/app/storageQuotaQueries.ts"),
