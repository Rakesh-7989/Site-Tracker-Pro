...
export const MOCK_USERS: Record<string, MockUser> = {
  ...
  pm_lead:   {id:"u203",name:"Ravi Teja",     email:"ravi@buildco.in",   role:"pm",   avatar:"RT",org_id:"org1"},
  ...
  site_engineer2: {id:"u206",name:"Lakshmi Patnaik",email:"lakshmi.p@buildco.in",role:"site_engineer",avatar:"LP",org_id:"org1"},
  site_inspector: {id:"u207",name:"Surya Prakash", email:"inspector@gov.in",  role:"site_inspector", avatar:"SP",org_id:"org1"},
  design_architect_interior:         {id:"u208",name:"Anjali Menon",     email:"anjali@designs.in",   role:"design_architect_interior",         avatar:"AM",org_id:"org1"},
  design_arch_interior2: {id:"u209",name:"Sneha Iyer",       email:"sneha@interiors.in",  role:"design_architect_interior", avatar:"SI",org_id:"org1"},
...
interface PlanMetaEntry {
  label: string;
  price: number;
  color: string;
}

export const PLAN_META: Record<string, PlanMetaEntry> = {
...
export const INIT_ADMIN_USERS: AdminUser[] = [
...
export const INIT_SUPPORT: SupportTicket[] = [
...
export const INIT_MILESTONES: Record<string, Milestone[]> = {
  p1:[
...
export const INIT_EXPENSES: Record<string, Expense[]> = {
  p1:[
...
export const INIT_TEAMS: Record<string, TeamMember[]> = {
  p1:[
...
export const INIT_ATTENDANCE: Record<string, Record<string, Record<string, string>>> = {
...
export const INIT_ISSUES: Record<string, Issue[]> = {
  p1:[
...
export const INIT_MATERIALS: Record<string, Material[]> = {
  p1:[
...
export const INIT_DRAWINGS: Record<string, Drawing[]> = {
  p1:[
...
export const INIT_ACTIVITY: ActivityEntry[] = [
...
export const INIT_TASKS: Record<string, Task[]> = {
  p1:[
...
export const INIT_PUNCH: Record<string, PunchItem[]> = {
  p1:[
...
export const INIT_RFI: Record<string, Rfi[]> = {
  p1:[
...
export const INIT_CO: Record<string, ChangeOrder[]> = {
  p1:[
...
export const INIT_INSPECTIONS: Record<string, Inspection[]> = {
  p1:[
...
export const INIT_SAFETY: Record<string, SafetyIncident[]> = {
  p1:[
...
export const INIT_POS: Record<string, PurchaseOrder[]> = {
  p1:[
...
export const INIT_INVOICES: Record<string, Invoice[]> = {
  p1:[
...
export const INIT_LABOUR: Record<string, Labour[]> = {
  p1:[
...
export const INIT_RA: Record<string, RaBill[]> = {
  p1:[
...
export const INIT_BOQ: Record<string, BoqItem[]> = {
  p1:[
...
export const INIT_ESTIMATE: Record<string, Estimate> = {
...
export const INIT_LEDGER: Record<string, LedgerEntry[]> = {
  p1:[
...
interface DemoSeed {
  ...
  updates: Record<string, SiteUpdate[]>;
  ...
  punch: Record<string, PunchItem[]>;
  rfi: Record<string, Rfi[]>;
  co: Record<string, ChangeOrder[]>;
  inspections: Record<string, Inspection[]>;
  safety: Record<string, SafetyIncident[]>;
  vendors: Vendor[];
  pos: Record<string, PurchaseOrder[]>;
  invoices: Record<string, Invoice[]>;
  labour: Record<string, Labour[]>;
  ra: Record<string, RaBill[]>;
  comments: Comment[];
  ...
  estimate: Record<string, Estimate>;
  orgs: Org[];
