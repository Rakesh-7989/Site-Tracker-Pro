// SiteTrack Pro — Seed mock data for the demo / paid-pilot path.
//
// This file holds the initial values for every useLS / usePersistent key
// the React app reads. When VITE_BACKEND=local (default), these are what
// the user sees. When VITE_BACKEND=supabase, they're replaced by real rows
// once Phase B3 migration runs.
//
// Extracted from src/App.jsx during LOW-5 / Split-2 (~400 lines of data
// moved out of the giant component file). No behaviour change.
