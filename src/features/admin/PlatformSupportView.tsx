  ...
  return (
    <div className="p-4 md:p-8 max-w-6xl mx-auto h-[calc(100vh-100px)]">
      ...
      <div className="grid grid-cols-12 gap-4 h-full">
        <div className="col-span-4 bg-white rounded-2xl overflow-hidden border border-stone-200 flex flex-col">
        ...
        <div className="col-span-8 bg-white rounded-2xl overflow-hidden border border-stone-200 flex flex-col">
          {ticket ? (
            <>
