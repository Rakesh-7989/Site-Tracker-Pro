    ...
    <div className="space-y-4">
      ...
      {canEdit && (
        <Card className="p-3 flex gap-2 flex-wrap items-end">
          ...
          <div><span className="text-[11px] font-semibold uppercase tracking-wider text-fg-tertiary">Total ₹</span><Input fit className="mt-1 w-32" type="number" value={total} onChange={e => setTotal(e.target.value)} /></div>
