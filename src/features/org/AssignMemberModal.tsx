    ...
    >
      <div className="space-y-5">
        ...
        <div className="space-y-3">
          <h4 className="text-xs font-semibold text-fg-primary">Find existing user</h4>
          ...
          {candidate && (
            <div className="mt-3 p-3 rounded-xl bg-secondary space-y-2">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-secondary flex items-center justify-center text-sm font-semibold text-fg-secondary">
                  {candidate.name.charAt(0).toUpperCase()}
                </div>
                <div>
                  <div className="font-medium text-fg-primary text-sm">{candidate.name}</div>
        ...
        <div className="border-t border-default pt-4">
          <h4 className="text-xs font-semibold text-fg-primary mb-3">Or invite a new person</h4>
          <div className="space-y-3">
            <Input
