...
function MaterialPricesInner(): JSX.Element {
  ...
  return (
    <div className="p-4 md:p-10 max-w-6xl">
      ...
      <div className="bg-white rounded-2xl p-5 mb-5 grid sm:grid-cols-5 gap-3 shadow-editorial border-st-line">
          ...
          {quotes.length > 0 && <>
            ...
            <div className="bg-white rounded-2xl overflow-x-auto shadow-editorial border-st-line">
              <div className="hidden md:grid grid-cols-12 gap-3 px-5 py-3 bg-cream-200/60 text-[10px] font-bold uppercase tracking-[0.18em] text-ink-500 border-b-st-line">
              ...
              {quotes.map((q: any, i: number) => (<div key={q.vendor_id} className={`grid grid-cols-12 gap-3 px-5 py-4 items-center text-sm${i < quotes.length - 1 ? " border-b-st-line" : ""}`}>
