  ...
  return (
    <div className="p-4 md:p-10 max-w-6xl">
      ...
      <div className="bg-panel rounded-2xl p-5 mb-5 grid sm:grid-cols-5 gap-3 shadow-editorial border-default">
            <div><label className="text-[10px] font-bold tracking-[0.24em] uppercase text-fg-secondary mb-1.5 block">Commodity</label><Select value={commodity} onChange={e => setCommodity(e.target.value)} options={Object.entries(COMMODITIES).map(([k, v]: any) => ({ value: k, label: v.label }))} /></div>
