...
export interface ProviderMeta { id: ProviderId; label: string; icon: string; help: string; fields: Array<[string, string]>; }

export const PROVIDERS: ProviderMeta[] = [
  { id: "whatsapp", label: "WhatsApp Business", icon: "send", help: "Send DPRs + invoice links via the WhatsApp Business API (your own Meta account).", fields: [["phone_id", "Phone number ID"], ["token", "System user access token"], ["template_id", "Template ID"]] },
