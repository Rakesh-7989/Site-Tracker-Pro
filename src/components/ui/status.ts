...
const MAP: Record<string, StatusColors> = {
  ...
  paused:      { bg: "bg-accent-tint",  text: "text-warning", border: "border-warning",     dot: "var(--st-warning)", bar: "var(--st-warning)" },
  deactivated: { bg: "bg-elevated",     text: "text-fg-secondary", border: "border-default", dot: "var(--st-text-tertiary)", bar: "var(--st-text-tertiary)" },
  cancelled:   { bg: "bg-error-tint",   text: "text-error",   border: "border-error",       dot: "var(--st-error)",  bar: "var(--st-error)" },
