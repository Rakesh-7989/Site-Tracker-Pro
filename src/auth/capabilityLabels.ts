...
export const FEATURE_LABEL: Record<string, string> = {
  ...
  "drawing:comment": "Comment on drawing revisions (x/y pins)",
  "drawing:approve": "Approve / reject / lock drawing revisions",
  "share:link:manage": "Create / revoke client share links",
  ...
  "platform:usage:view": "View cross-tenant usage stats",
  "platform:support:manage": "Triage / close support tickets",
  "platform:branding:manage": "Manage platform-wide branding",
  "platform:featureflags:manage": "Manage platform feature flags",
...
const GROUP_BY_DOMAIN: Record<string, string> = {
  ...
  drawings: "drawings", drawing: "drawings", boq: "boq", estimate: "boq",
