...
3. **Deploy** — deploy the `prod` branch to Vercel (project `sitetrack-rakesh`, org `team_Qd2Yf5z3r5asmq3HeHxCSie1`, production branch `prod`, URL https://sitetrack-rakesh.vercel.app). Use Vercel/GitHub Actions as configured; never commit secrets.
