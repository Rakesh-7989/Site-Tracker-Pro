...
3. **Current state** — what already exists (route, view, query, table, capability). Check `docs/planning/END_TO_END_PLAN.md` status table and the code before claiming a gap.
