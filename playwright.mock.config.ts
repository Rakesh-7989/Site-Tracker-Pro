...
export default defineConfig({
  testDir: "./e2e-mock",
  // ux-audit + a11y are diagnostic sweeps — run them explicitly via
  // `npm run test:ux` / `npm run test:a11y`, not in every gate/CI pass.
  testIgnore: ["**/ux-audit.spec.ts", "**/a11y.spec.ts"],  timeout: 60000,
