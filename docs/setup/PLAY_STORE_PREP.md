...
- [ ] `docs/setup/CONNECT_SUPABASE.md` checklist passed (production DB live)
- [ ] `docs/setup/CASHFREE_ONBOARDING.md` Edge Functions deployed
...
- [ ] Sentry MCP connected for crash monitoring (see `docs/integrations/MCP_TOOLKIT.md`
      Part C)
...
- `docs/setup/CONNECT_SUPABASE.md` — database must be live first
- `docs/setup/CASHFREE_ONBOARDING.md` — subscription billing
- `docs/setup/DEPLOY_NOW.md` — web deployment
- `docs/integrations/MCP_TOOLKIT.md` — Sentry MCP for post-launch monitoring
