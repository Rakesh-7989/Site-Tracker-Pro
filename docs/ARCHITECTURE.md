...
[docs/CONNECT_SUPABASE.md](docs/CONNECT_SUPABASE.md) for the 8-step server-side bootstrap.
...
permission matrix. See [docs/ROLE_MODEL_V2.md](docs/ROLE_MODEL_V2.md).
...
See [docs/PLAY_STORE_PREP.md](docs/PLAY_STORE_PREP.md) for the 8-step submission runbook.
...
Day 4  ── Docs               docs/CASHFREE_ONBOARDING.md (8-week verification path)
