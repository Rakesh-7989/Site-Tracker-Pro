...
Every `WARNING  FAIL` line is a regression — see `docs/PRODUCTION_RLS.md`
...
`docs/CASHFREE_ONBOARDING.md` to wire payments next.
...
`supabase/functions/cashfree-webhook/` — see `docs/CASHFREE_ONBOARDING.md`
