...
- 📞 [4 PM] Begin Step 0 of `docs/CONNECT_SUPABASE.md` — rotate ALL four
...
- 🛠️ [9-11 AM] Follow `docs/CONNECT_SUPABASE.md` Step 1: create fresh
...
- 🛠️ [2-3 PM] Generate release keystore per `docs/PLAY_STORE_PREP.md` Step 3.
...
- 🛠️ [9-12 AM] Pay $25 Play Console signup if not already done. Create
  app listing per `docs/PLAY_STORE_PREP.md` Step 6.
...
- 🛠️ [4-6 PM] Wire in-app updates per `docs/PLAY_STORE_PREP.md` Step 8.
...
- 🛠️ [9-12 AM] Walk through `docs/PRODUCTION_RLS.md` final checklist.
