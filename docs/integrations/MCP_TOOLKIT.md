...
- **SiteTrack workflow it replaces / accelerates:**
  ...
  - This automates most of `docs/setup/CONNECT_SUPABASE.md`'s manual psql steps.
...
- **Rotate the earlier-leaked Supabase credentials FIRST** (see
  `docs/setup/CONNECT_SUPABASE.md` Step 0) before issuing any new PAT.
...
- `docs/setup/CONNECT_SUPABASE.md` — database connection (Supabase MCP automates much of it)
- `docs/setup/DEPLOY_NOW.md` — deploy runbook (Vercel MCP helps here)
